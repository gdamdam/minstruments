...
| **mspectr** _(beta)_ | A spectral resynthesis instrument for capturing what sounds are made of, then morphing and playing that identity. | [mspectr.mpump.live](https://mspectr.mpump.live/) | [gdamdam/mspectr](https://github.com/gdamdam/mspectr) |
| **mvox** _(beta)_ | A browser voice instrument for synthesizing, harmonizing, and reshaping the human voice. | [mvox.mpump.live](https://mvox.mpump.live/) | [gdamdam/mvox](https://github.com/gdamdam/mvox) |
...
| **mraga** _(alpha)_ | A conductable generative microtonal instrument that improvises a struck raga line over an mdrone drone in its exact tuning. | [mraga.mdrone.org](https://mraga.mdrone.org) | [gdamdam/mraga](https://github.com/gdamdam/mraga) |
...
| **mbus** _(beta)_ | A local-first audio patchbay that discovers each instrument's live output and patches it into a monitored master mix, tab-to-tab over WebRTC. | [mbus.mpump.live](https://mbus.mpump.live/) | [gdamdam/mbus](https://github.com/gdamdam/mbus) |
